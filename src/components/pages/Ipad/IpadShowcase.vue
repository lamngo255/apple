<template>
  <div class="showcase">
    ...
    <div class="ip ipad-mini">
      <img :src="genIpadImage('ipad-mini')" alt="" />
      <div class="info">
...
.showcase {
  ...
  .new {
    @include textMixin(#c04800, 0.14rem);
  ...
  .btn-learn {
    @include textMixin(#0171e3, 0.18rem);
    margin-top: 0.1rem;
    margin-left: -0.05rem;
    border: none;
    background: none;
